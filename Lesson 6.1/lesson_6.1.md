...
The value of mistakes is that we either learn from them or they keep giving us chances to learn from them -until we eventually do- (quitting before success shouldn't be an option, so we treat quitting as a mistake too).
